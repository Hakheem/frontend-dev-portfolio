...
const ProjectCard = ({ project }: ProjectCardProps) => {
  const { title, slug, customSlug, shortDescription, mainImage, links, category } = project;
  ...
  return (
    <div className="group bg-gradient-to-br from-gray-900 via-gray-900 to-gray-950 rounded-lg overflow-hidden border border-gray-800/50 transition-all duration-300 hover:border-primary/30 hover:shadow-lg">
      {/* Image Container */}
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-800/50">
          <div className="flex items-center gap-3">
            {liveLink && (
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 bg-primary/20 text-primary text-sm font-medium rounded-lg hover:bg-primary/30 transition-colors"
          ...
          <button
            ...
            className="cursor-pointer flex items-center gap-2 text-primary text-sm font-medium hover:text-primary/80 transition-colors"
          >
            Details
            <ArrowRight size={16} />
          </button>
